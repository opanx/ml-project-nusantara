    ...
    namespace detail {
                ...
                static std::unordered_map<size_t, std::unordered_map<void **, const char *>> patchesTable = {
                        {
                                16,
                                {
                                        ...
                                        {reinterpret_cast<void **>(&SurfaceControl__GetSurface),               "_ZN7android14SurfaceControl10getSurfaceEv"},
                                        {reinterpret_cast<void **>(&SurfaceComposerClient__GetDisplayState),   "_ZN7android21SurfaceComposerClient15getDisplayStateERKNS_2spINS_7IBinderEEEPNS_2ui12DisplayStateE"},
                                        {reinterpret_cast<void **>(&SurfaceComposerClient__GetPhysicalDisplayIds), "_ZN7android21SurfaceComposerClient21getPhysicalDisplayIdsEv"},
                                        {reinterpret_cast<void **>(&SurfaceComposerClient__GetPhysicalDisplayToken), "_ZN7android21SurfaceComposerClient23getPhysicalDisplayTokenENS_17PhysicalDisplayIdE"},
                                },
                        },
                        {
                                15,
        ...
        struct String8 {
            ...
            String8(const char *const string) {
                if (nullptr == Functionals::GetInstance().String8__Constructor)
                    return;
                Functionals::GetInstance().String8__Constructor(data, string);
            }

            ~String8() {
                if (nullptr == Functionals::GetInstance().String8__Destructor)
                    return;
        ...
        struct LayerMetadata {
            ...
            LayerMetadata() {
                if (9 < Functionals::GetInstance().systemVersion &&
                    nullptr != Functionals::GetInstance().LayerMetadata__Constructor)
                    Functionals::GetInstance().LayerMetadata__Constructor(data);
            }

            void setInt32(uint32_t type, int32_t value) {
                if (9 < Functionals::GetInstance().systemVersion &&
                    nullptr != Functionals::GetInstance().LayerMetadata__setInt32)
        ...
        struct SurfaceComposerClient {
            ...
            SurfaceComposerClient() {
                if (nullptr == Functionals::GetInstance().SurfaceComposerClient__Constructor)
                    return;
            ...
            SurfaceControl CreateSurface(const char *name, int32_t width, int32_t height, bool hide, bool secure) {
                ...
                if (nullptr == F.SurfaceComposerClient__CreateSurface) {
                    printf("[ANWC] createSurface null - Android %zu tidak didukung\n", F.systemVersion);
                    return {};
                }
                ...
                if (12 <= Functionals::GetInstance().systemVersion) {
                    ...
                    if (nullptr != Functionals::GetInstance().SurfaceComposerClient__Transaction__SetTrustedOverlay &&
                        nullptr != Functionals::GetInstance().SurfaceComposerClient__Transaction__Apply &&
            ...
            bool GetDisplayInfo(ui::DisplayState *displayInfo) {
                ...
                if (9 >= Functionals::GetInstance().systemVersion)
                    ...
                    if (14 > Functionals::GetInstance().systemVersion) {
                        if (nullptr == Functionals::GetInstance().SurfaceComposerClient__GetInternalDisplayToken)
                            return false;
                        defaultDisplay = Functionals::GetInstance().SurfaceComposerClient__GetInternalDisplayToken();
                    } else {
                        if (nullptr == Functionals::GetInstance().SurfaceComposerClient__GetPhysicalDisplayIds ||
                            nullptr == Functionals::GetInstance().SurfaceComposerClient__GetPhysicalDisplayToken)
                            return false;
                ...
                if (11 <= Functionals::GetInstance().systemVersion) {
                    if (nullptr == Functionals::GetInstance().SurfaceComposerClient__GetDisplayState)
                        return false;
